...
export default function CompositionsTab({
  ...
  const [exportOptions, setExportOptions] = useState<CompositionExportOptions>({
          ...
          {compositions.map((composition) => (
            <div className="card" key={composition.id}>
              ...
              <div style={{ display: 'flex', gap: '0.5rem', marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid var(--card-border)' }}>
                <button type="button" className="btn btn-primary btn-sm" style={{ flex: 1 }} onClick={() => openExportModal(composition.id)}>
        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 1.25rem', borderBottom: '1px solid var(--card-border)' }}>
              ...
              <button type="button" className="btn btn-icon btn-secondary" onClick={() => setShowExportModal(false)}>
                <i className="bi bi-x-lg"></i>
              </button>
            </div>
            <div style={{ padding: '1.25rem' }}>
              <p style={{ marginBottom: '1rem', color: 'var(--text-secondary)' }}>Configure export options for the combined MCP server package.</p>
              <div className="form-group">
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.8125rem', color: 'var(--text-muted)' }}>Add server name prefix to all tools (e.g., weather_get_forecast)</div>
                  </div>
                </label>
              </div>
              <div className="form-group">
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.8125rem', color: 'var(--text-muted)' }}>Include resources from all servers in the composition</div>
                  </div>
                </label>
              </div>
              <div className="form-group">
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.8125rem', color: 'var(--text-muted)' }}>Include prompts from all servers in the composition</div>
                  </div>
                </label>
              </div>
              <div style={{ marginTop: '1rem', padding: '0.75rem', background: 'var(--hover-bg)', borderRadius: '6px', fontSize: '0.8125rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem', padding: '1rem 1.25rem', borderTop: '1px solid var(--card-border)' }}>
              ...
              <button type="button" className="btn btn-primary" onClick={handleExport} disabled={exporting}>
                {exporting ? (
                  <>
                    <span className="spinner" style={{ width: 16, height: 16, marginRight: '0.5rem', display: 'inline-block' }}></span>
                    Generating...
                  </>
                ) : (
                  <>
