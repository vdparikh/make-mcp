          ...
          <div className={`top-nav-menu ${openMenu === 'build' ? 'open' : ''}`}>
            ...
            <div className="top-nav-dropdown top-nav-mega">
              ...
              <div className="top-nav-mega-col">
                ...
                <button type="button" className="top-nav-mega-item" onClick={() => navigate('/import/server-json')}>
                  <i className="bi bi-file-earmark-text" />
                  <span>
                    <strong>Import Server JSON</strong>
                    <small>Clone a server config via JSON export/import.</small>
                  </span>
                </button>
