...
export default function HealingDashboard({ tools, initialToolId, lockToolSelection }: Props) {
      ...
      <div className="card" style={{ marginBottom: '1.5rem' }}>
        ...
        <div style={{ 
          ...
          <div style={{ marginTop: '0.75rem', fontSize: '0.8rem' }}>
            <a
              href="https://github.com/vdparikh/make-mcp/blob/main/docs/security-best-practices.md#logging-and-healing"
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: '#38bdf8', textDecoration: 'none' }}
            >
              <i className="bi bi-box-arrow-up-right" style={{ marginRight: '0.25rem' }}></i>
              Read more about healing & observability
            </a>
          </div>
        </div>
      </div>
