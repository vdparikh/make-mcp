...
export default function FlowBuilderPage() {
  ...
  const handleConvert = (nodes: Node[], edges: Edge[]) => {
    ...
    setToolName(currentFlow.name.replace(/\s+/g, '_').toLowerCase());
  ...
  const performConvert = async () => {
    ...
    setConverting(true);
    try {
      await convertFlowToTool(currentFlow.id, toolName, toolDescription);
          ...
          <div className="flow-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flow-modal-body">
              ...
              <div className="form-group">
                ...
                />
                <small style={{ color: 'var(--text-muted)' }}>Use snake_case (e.g., my_flow_tool)</small>
              </div>
